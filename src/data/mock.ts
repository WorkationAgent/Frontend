  ...
  candidates: [
    {
      ...
      sections: {
        work: {
          ...
          items: [
            { name: "숙소 작업 공간", sub: "조용하고 편안한 책상", rating: 3.5 },
            { name: "함덕 코워킹 카페", sub: "차 8분, 좌석 보통", rating: 3.0 },
          ],
        },
        living: {
          score: 82,
          ...
          items: [
            { name: "GS25 함덕라마다점", sub: "숙소 인근 위치, 생활 편의점", rating: 5.0 },
            { name: "함덕농협하나로마트 중앙점", sub: "신선한 식료품 구매 가능", rating: 4.5 },
            { name: "함덕바른한의원", sub: "근접 의료 시설", rating: 4.0 },
            { name: "회춘 주차장", sub: "편리한 주차 공간", rating: 4.0 },
          ],
        },
        local: {
          score: 84,
          ...
          items: [
            { name: "함덕해수욕장 (함덕 서우봉 해변)", sub: "근처 대표 해변 및 산책로", rating: 5.0 },
            { name: "조천함덕해안도로", sub: "아름다운 해안선 도보 코스", rating: 4.5 },
            { name: "카페봄봄 함덕점", sub: "숙소 근처 분위기 좋은 카페", rating: 4.0 },
          ],
        },
      },
    },
    {
      ...
      sections: {
        work: {
          ...
          items: [
            { name: "숙소 전용 워크데스크", sub: "넓고 조용한 작업 공간", rating: 4.5 },
            { name: "표선 감성 카페", sub: "콘센트·좌석 여유", rating: 4.0 },
          ],
        },
        living: {
          score: 65,
          ...
          items: [
            { name: "CU 표선가마리점", sub: "근거리 편의점", rating: 4.0 },
            { name: "표선119센터", sub: "긴급 서비스가 다소 멀리 있음", rating: 2.0 },
          ],
        },
        local: {
          score: 86,
          ...
          items: [
            { name: "제주허브동산", sub: "테마파크 및 식물원", rating: 4.5 },
            { name: "표선해수욕장", sub: "조용한 해변", rating: 4.0 },
            { name: "솔옆수 카페", sub: "지역 유명 카페", rating: 4.0 },
          ],
        },
      },
    },
    {
      ...
      sections: {
        work: {
          ...
          items: [
            { name: "숙소 와이파이", sub: "속도 보통", rating: 2.5 },
            { name: "애월 카페거리", sub: "차 10분", rating: 3.0 },
          ],
        },
        living: {
          score: 70,
          ...
          items: [
            { name: "CU 제주고내리점", sub: "생활 편의 편의점", rating: 3.5 },
            { name: "애월보건지소", sub: "의료 서비스가 다소 거리 있음", rating: 3.0 },
            { name: "애월119안전센터", sub: "긴급 서비스가 10분 거리", rating: 3.0 },
          ],
        },
        local: {
          score: 80,
          ...
          items: [
            { name: "고내포구", sub: "해안 관광명소", rating: 4.5 },
            { name: "한담해변", sub: "조용한 해변 산책 코스", rating: 4.0 },
          ],
        },
      },
    },
